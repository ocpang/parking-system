		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item"><a href="{{ route('book') }}">Master Books</a></li>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header row">
								<div class="col-md-6">Edit Master Book</div>
								<div class="col-md-6 text-right">
									<!--begin::Button-->
									<a href="{{ route('book') }}" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">Back</a>
									<!--end::Button-->
								</div>
							</div>
							<div class="card-body">
								<form id="form_data" role="form" action="{{ route('book.save', $book->id) }}" method="POST">
									@csrf
									@method('POST')
									<div class="card">
										<div class="card-body">
												...
												<div class="col-xl-12">
													<div class="row justify-content-center">
														<div class="col-xl-9">
															...
															<input name="id" id="id_data" value="{{$book->id}}" type="hidden">
															
															<!--begin::Group-->
															<div class="form-group row fv-plugins-icon-container">
																<label class="col-xl-3 col-lg-3 col-form-label">Title*</label>
																<div class="col-lg-9 col-xl-9 title_field">
																	<input class="form-control form-control-solid form-control-lg" name="title" type="text" maxlength="100" value="{{ $book->title }}">
															...
															<div class="form-group row fv-plugins-icon-container">
																...
																<div class="col-lg-9 col-xl-9 author_field">
																	<input class="form-control form-control-solid form-control-lg" name="author" type="text" maxlength="100" value="{{ $book->author }}">
																	<div class="fv-plugins-message-container text-danger"></div>
																</div>
															</div>
															<!--end::Group-->
															...
															<!--begin::Group-->
															<div class="form-group row fv-plugins-icon-container">
																<label class="col-xl-3 col-lg-3 col-form-label">Genre</label>
																<div class="col-lg-9 col-xl-9 genre_field">
																	<input class="form-control form-control-solid form-control-lg" name="genre" type="text" maxlength="100" value="{{ $book->genre }}">
																	<div class="fv-plugins-message-container text-danger"></div>
																</div>
															</div>
															<!--end::Group-->
		...
		$.ajax({
			...
			success:function(data){
				if(data.status=="success"){
					...
					setTimeout(function(){ window.location.replace("{{ route('book.edit') .'/'. $book->id }}"); }, 1000);
