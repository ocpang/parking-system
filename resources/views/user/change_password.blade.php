									...
									<div class="col-xl-12">
										<div class="row justify-content-center">
											<div class="col-xl-9">
												...
												@endif
												<form id="form_data" role="form" action="{{ route('user.save_password', \Auth::user()->id) }}" method="POST">
													@csrf
													@method('POST')
									                <input name="id" id="id_data" value="{{ \Auth::user()->id }}" type="hidden">

													<!--begin::Group-->
													<div class="form-group row fv-plugins-icon-container">
														<label class="col-xl-3 col-lg-3 col-form-label">Current Password*</label>
														<div class="col-lg-9 col-xl-9 old_password_field">
															<input class="form-control form-control-solid form-control-lg" name="old_password" type="password" value="">
